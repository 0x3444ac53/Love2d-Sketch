...
package.preload["fennel.repl"] = package.preload["fennel.repl"] or function(...)
  ...
  local function default_on_error(errtype, err)
    local function _677_()
      local _676_0 = errtype
      if (_676_0 == "Runtime") then
  ...
  local function splice_save_locals(env, lua_source, scope)
    ...
    local function _686_()
      local _684_0, _685_0 = lua_source:match("^(.*)[\n ](return .*)$")
      if ((nil ~= _684_0) and (nil ~= _685_0)) then
        local body = _684_0
        local _return = _685_0
  ...
  local function completer(env, scope, text, _3ffulltext, _from, _to)
    ...
    local function add_partials(input, tbl, prefix)
      ...
      for k, is_mangled in utils.allpairs(_688_()) do
    ...
    do
      local _697_0 = tostring((_3ffulltext or text)):match("^%s*,([^%s()[%]]*)$")
      if (nil ~= _697_0) then
        local cmd_fragment = _697_0
  ...
  local function reload(module_name, env, on_values, on_error)
    local _701_0, _702_0 = pcall(specials["load-code"]("return require(...)", env), module_name)
    if ((_701_0 == true) and (nil ~= _702_0)) then
      ...
      local new = nil
      do
        local _703_0, _704_0 = pcall(require, module_name)
        if ((_703_0 == true) and (nil ~= _704_0)) then
          local new0 = _704_0
          new = new0
        elseif (true and (nil ~= _704_0)) then
          local _0 = _703_0
          local msg = _704_0
          on_error("Repl", msg)
          new = old
      ...
      return on_values({"ok"})
    elseif ((_701_0 == false) and (nil ~= _702_0)) then
      local msg = _702_0
      ...
      elseif specials["macro-loaded"][module_name] then
        ...
        local function _709_()
          local _708_0 = msg:gsub("\n.*", "")
          return _708_0
        end
        return on_error("Runtime", _709_())
      end
    end
  end
  local function run_command(read, on_error, f)
    local _712_0, _713_0, _714_0 = pcall(read)
    if ((_712_0 == true) and (_713_0 == true) and (nil ~= _714_0)) then
      local val = _714_0
      local _715_0, _716_0 = pcall(f, val)
      if ((_715_0 == false) and (nil ~= _716_0)) then
        local msg = _716_0
        return on_error("Runtime", msg)
      end
    elseif (_712_0 == false) then
      return on_error("Parse", "Couldn't parse input.")
    end
  end
  commands.reload = function(env, read, on_values, on_error)
    local function _719_(_241)
      return reload(tostring(_241), env, on_values, on_error)
    end
    return run_command(read, on_error, _719_)
  end
  ...
  commands.complete = function(env, read, on_values, on_error, scope, chars)
    ...
    return run_command(read, on_error, _720_)
  end
  ...
  local function apropos_2a(pattern, tbl, prefix, seen, names)
    for name, subtbl in pairs(tbl) do
      if (("string" == type(name)) and (package ~= subtbl)) then
        local _721_0 = type(subtbl)
        if (_721_0 == "function") then
          if ((prefix .. name)):match(pattern) then
            table.insert(names, (prefix .. name))
          end
        elseif (_721_0 == "table") then
          if not seen[subtbl] then
            ...
            apropos_2a(pattern, subtbl, (prefix .. name:gsub("%.", "/") .. "."), _723_, names)
          end
        end
      end
    end
  ...
  commands.apropos = function(_env, read, on_values, on_error, _scope)
    local function _727_(_241)
      return on_values(apropos(tostring(_241)))
    end
    return run_command(read, on_error, _727_)
  end
    ...
    for _, path in ipairs(apropos(".*")) do
      ...
      do
        ...
        if ("function" == type(tgt)) then
          local _731_0 = (compiler.metadata):get(tgt, "fnl/docstring")
          if (nil ~= _731_0) then
            local docstr = _731_0
  ...
  commands["apropos-show-docs"] = function(_env, read, on_values, on_error)
    local function _737_(_241)
      return apropos_show_docs(on_values, tostring(_241))
    end
    return run_command(read, on_error, _737_)
  end
  ...
  local function resolve(identifier, _738_0, scope)
    local _739_ = _738_0
    local env = _739_
    local ___replLocals___ = _739_["___replLocals___"]
    local e = nil
    local function _740_(_241, _242)
      return (___replLocals___[scope.unmanglings[_242]] or env[_242])
    end
    e = setmetatable({}, {__index = _740_})
    local function _741_(...)
      local _742_0, _743_0 = ...
      if ((_742_0 == true) and (nil ~= _743_0)) then
        local code = _743_0
        local function _744_(...)
          local _745_0, _746_0 = ...
          if ((_745_0 == true) and (nil ~= _746_0)) then
            local val = _746_0
            return val
          else
            local _ = _745_0
        ...
        return _744_(pcall(specials["load-code"](code, e)))
      else
        local _ = _742_0
        return nil
      end
    end
    return _741_(pcall(compiler["compile-string"], tostring(identifier), {scope = scope}))
  end
  commands.find = function(env, read, on_values, on_error, scope)
    local function _749_(_241)
      local _750_0 = nil
      do
        local _751_0 = utils["sym?"](_241)
        if (nil ~= _751_0) then
          local _752_0 = resolve(_751_0, env, scope)
          if (nil ~= _752_0) then
            _750_0 = debug.getinfo(_752_0)
          else
            _750_0 = _752_0
          end
        else
      ...
      if ((_G.type(_750_0) == "table") and (nil ~= _750_0.linedefined) and (nil ~= _750_0.short_src) and (nil ~= _750_0.source) and (_750_0.what == "Lua")) then
        local line = _750_0.linedefined
        local src = _750_0.short_src
        local source = _750_0.source
        local fnlsrc = nil
        do
          local _755_0 = compiler.sourcemap
          if (nil ~= _755_0) then
            _755_0 = _755_0[source]
          end
          if (nil ~= _755_0) then
            _755_0 = _755_0[line]
          end
    ...
    return run_command(read, on_error, _749_)
  end
  ...
  commands.doc = function(env, read, on_values, on_error, scope)
    local function _760_(_241)
      ...
      local function _761_()
        return (scope.specials[path] or utils["get-in"](scope.macros, path) or resolve(name, env, scope))
      end
      ok_3f, target = pcall(_761_)
      if ok_3f then
  ...
  commands.compile = function(_, read, on_values, on_error, _0, _1, opts)
    local function _763_(_241)
      local _764_0, _765_0 = pcall(compiler.compile, _241, opts)
      if ((_764_0 == true) and (nil ~= _765_0)) then
        local result = _765_0
        return on_values({result})
      elseif (true and (nil ~= _765_0)) then
        local _2 = _764_0
        local msg = _765_0
        return on_error("Repl", ("Error compiling expression: " .. msg))
      end
    end
    return run_command(read, on_error, _763_)
  end
  ...
  local function load_plugin_commands(plugins)
    for i = #(plugins or {}), 1, -1 do
      for name, f in pairs(plugins[i]) do
        local _767_0 = name:match("^repl%-command%-(.*)")
        if (nil ~= _767_0) then
          local cmd_name = _767_0
          commands[cmd_name] = f
        end
      end
    end
  ...
  local function run_command_loop(input, read, loop, env, on_values, on_error, scope, chars, opts)
    ...
    do
      local _769_0 = commands[command_name]
      if (nil ~= _769_0) then
        local command = _769_0
  ...
  local function repl(_3foptions)
    ...
    local _778_ = utils.copy(_3foptions)
    local opts = _778_
    local _3ffennelrc = _778_["fennelrc"]
    local _ = nil
    opts.fennelrc = nil
    _ = nil
    ...
    local function _780_(_241)
      return callbacks.readChunk(_241)
    end
    byte_stream, clear_stream = parser.granulate(_780_)
    local chars = {}
    local read, reset = nil, nil
    local function _781_(parser_state)
    ...
    read, reset = parser.parser(_781_)
    depth = (depth + 1)
    ...
    if opts.registerCompleter then
      local function _787_()
        local _786_0 = opts.scope
        local function _788_(...)
          return completer(env, _786_0, ...)
        end
        return _788_
      end
      opts.registerCompleter(_787_())
    end
      ...
      elseif command_3f(src_string) then
        ...
        if not_eof_3f then
          local function _792_(...)
            local _793_0, _794_0 = ...
            if ((_793_0 == true) and (nil ~= _794_0)) then
              local src = _794_0
              local function _795_(...)
                local _796_0, _797_0 = ...
                if ((_796_0 == true) and (nil ~= _797_0)) then
                  local chunk = _797_0
                  ...
                  return xpcall(_798_, _799_)
                elseif ((_796_0 == false) and (nil ~= _797_0)) then
                  local msg = _797_0
                  clear_stream()
              ...
              return _795_(_802_(...))
            elseif ((_793_0 == false) and (nil ~= _794_0)) then
              local msg = _794_0
              clear_stream()
              return callbacks.onError("Compile", msg)
            end
          ...
          _792_(pcall(compiler.compile, form, _804_()))
  ...
  local function _810_(overrides, _3fopts)
    return repl(utils.copy(_3fopts, utils.copy(overrides)))
  end
  return setmetatable({}, {__call = _810_, __index = {repl = repl}})
end
package.preload["fennel.specials"] = package.preload["fennel.specials"] or function(...)
  ...
  SPECIALS.values = function(ast, scope, parent, opts)
    local len = #ast
    local exprs = {}
    for i = 2, len do
      local subexprs = nil
      ...
      if (i ~= len) then
        _472_ = 1
      elseif opts.nval then
        _472_ = math.max(1, (opts.nval - (len - 2)))
      else
      _472_ = nil
      end
      subexprs = compiler.compile1(ast[i], scope, parent, {nval = _472_})
  ...
  local function compile_value(v)
    ...
    local chunk = {}
    local _477_ = compiler.compile1(v, scope, chunk, opts)
    local _478_ = _477_[1]
    local v0 = _478_[1]
    return v0
  end
  ...
  local function get_fn_name(ast, scope, fn_name, multi)
    if (fn_name and (fn_name[1] ~= "nil")) then
      local _483_
      if not multi then
        _483_ = compiler["declare-local"](fn_name, scope, ast)
      else
        _483_ = compiler["symbol-to-expression"](fn_name, scope)[1]
      end
      return _483_, not multi, 3
    else
      return nil, true, 2
    end
  end
  local function compile_named_fn(ast, f_scope, f_chunk, parent, index, fn_name, local_3f, arg_name_list, f_metadata)
    ...
    local _486_
    if local_3f then
      _486_ = "local function %s(%s)"
    else
      _486_ = "%s = function(%s)"
    end
    compiler.emit(parent, string.format(_486_, fn_name, table.concat(arg_name_list, ", ")), ast)
  ...
  local function get_function_metadata(ast, arg_list, index)
    local function _489_(_241, _242)
      local tbl_14_ = _241
    ...
    local function _491_(_241, _242)
      _241["fnl/docstring"] = _242
      return _241
    end
    return maybe_metadata(ast, utils["kv-table?"], _489_, maybe_metadata(ast, utils["string?"], _491_, {["fnl/arglist"] = arg_list}, index))
  end
  SPECIALS.fn = function(ast, scope, parent, opts)
    local f_scope = nil
    do
      local _492_0 = compiler["make-scope"](scope)
      _492_0["vararg"] = false
      f_scope = _492_0
    end
    local f_chunk = {}
  ...
  SPECIALS.lua = function(ast, _, parent)
    ...
    local _498_
    do
      local _497_0 = utils["sym?"](ast[2])
      if (nil ~= _497_0) then
        _498_ = tostring(_497_0)
      else
        _498_ = _497_0
      end
    end
    ...
    local _502_
    do
      local _501_0 = utils["sym?"](ast[3])
      if (nil ~= _501_0) then
        _502_ = tostring(_501_0)
      else
        _502_ = _501_0
      end
    end
  ...
  local function dot(ast, scope, parent)
    ...
    local _505_ = compiler.compile1(lhs_node, scope, parent, {nval = 1})
    local lhs = _505_[1]
    if (len == 2) then
      return tostring(lhs)
    else
      ...
      for i = 3, len do
        ...
        if (utils["string?"](index) and utils["valid-lua-identifier?"](index)) then
          ...
          local _506_ = compiler.compile1(index, scope, parent, {nval = 1})
          local index0 = _506_[1]
  ...
  SPECIALS.let = function(_513_0, scope, parent, opts)
    local _514_ = _513_0
    local _ = _514_[1]
    local bindings = _514_[2]
    local ast = _514_
  ...
  local function if_2a(ast, scope, parent, opts)
    ...
    if (#ast == 2) then
      ...
      for i = 2, (#ast - 1), 2 do
        local condchunk = {}
        local _523_ = compiler.compile1(ast[i], do_scope, condchunk, {nval = 1})
        local cond = _523_[1]
  ...
  local function remove_until_condition(bindings, ast)
    ...
    for i = (#bindings - 1), 3, -1 do
      local _529_0 = clause_3f(bindings[i])
      if ((_529_0 == false) or (_529_0 == nil)) then
      elseif (nil ~= _529_0) then
        local clause = _529_0
  ...
  local function compile_until(_3fcondition, scope, chunk)
    if _3fcondition then
      local _531_ = compiler.compile1(_3fcondition, scope, chunk, {nval = 1})
      local condition_lua = _531_[1]
  ...
  local function method_call(ast, scope, parent)
    ...
    local _542_ = compiler.compile1(ast[2], scope, parent, {nval = 1})
    local target = _542_[1]
    local args = {}
    for i = 4, #ast do
      local subexprs = nil
      local _543_
      ...
      subexprs = compiler.compile1(ast[i], scope, parent, {nval = _543_})
      local tbl_17_ = args
      local i_18_ = #tbl_17_
    ...
    local _546_0 = method_special_type(ast)
    if (_546_0 == "native") then
      return native_method_call(ast, scope, parent, target, args)
    elseif (_546_0 == "nonnative") then
      return nonnative_method_call(ast, scope, parent, target, args)
    elseif (_546_0 == "binding") then
  ...
  SPECIALS.hashfn = function(ast, scope, parent)
    ...
    local f_scope = nil
    do
      local _553_0 = compiler["make-scope"](scope)
      _553_0["vararg"] = false
      _553_0["hashfn"] = true
      f_scope = _553_0
    end
  ...
  local function short_circuit_safe_3f(x, scope)
    ...
    elseif utils["list?"](x) then
      if utils["sym?"](x[1]) then
        local _560_0 = str1(x)
        if ((_560_0 == "fn") or (_560_0 == "hashfn") or (_560_0 == "let") or (_560_0 == "local") or (_560_0 == "var") or (_560_0 == "set") or (_560_0 == "tset") or (_560_0 == "if") or (_560_0 == "each") or (_560_0 == "for") or (_560_0 == "while") or (_560_0 == "do") or (_560_0 == "lua") or (_560_0 == "global")) then
          return false
        elseif (((_560_0 == "<") or (_560_0 == ">") or (_560_0 == "<=") or (_560_0 == ">=") or (_560_0 == "=") or (_560_0 == "not=") or (_560_0 == "~=")) and (comparator_special_type(x) == "binding")) then
          return false
        else
          local function _561_()
            return (1 ~= x[2])
          end
          if ((_560_0 == "pick-values") and _561_()) then
            return false
          else
  ...
  local function emit_short_circuit_if(ast, scope, parent, name, subast, accumulator, expr_string, setter)
    ...
    compiler.emit(parent, ("if %s then"):format(_572_()), subast)
    do
      local chunk = {}
  ...
  local function define_arithmetic_special(name, zero_arity, unary_prefix, _3flua_name)
    local _578_
    do
      local _577_0 = (_3flua_name or name)
      local function _579_(...)
        return operator_special(_577_0, zero_arity, unary_prefix, ...)
      end
      _578_ = _579_
    end
    SPECIALS[name] = _578_
  ...
  SPECIALS.bnot = function(ast, scope, parent)
    compiler.assert((#ast == 2), "expected one argument", ast)
    local _588_ = compiler.compile1(ast[2], scope, parent, {nval = 1})
    local value = _588_[1]
    if utils.root.options.useBitLib then
  ...
  local function native_comparator(op, _590_0, scope, parent)
    local _591_ = _590_0
    local _ = _591_[1]
    local lhs_ast = _591_[2]
    local rhs_ast = _591_[3]
    local _592_ = compiler.compile1(lhs_ast, scope, parent, {nval = 1})
    local lhs = _592_[1]
    local _593_ = compiler.compile1(rhs_ast, scope, parent, {nval = 1})
    local rhs = _593_[1]
  ...
  local function binding_comparator(op, chain_op, ast, scope, parent)
    ...
    return ("(" .. table.concat(_597_, chain) .. ")")
  end
  local function define_comparator_special(name, _3flua_op, _3fchain_op)
    do
      ...
      local function opfn(ast, scope, parent)
        ...
        local _599_0 = comparator_special_type(ast)
        if (_599_0 == "native") then
          return native_comparator(op, ast, scope, parent)
        elseif (_599_0 == "idempotent") then
          return idempotent_comparator(op, _3fchain_op, ast, scope, parent)
        elseif (_599_0 == "binding") then
  ...
  local function make_compiler_env(ast, scope, parent, _3fopts)
    local provided = nil
    do
      local _607_0 = (_3fopts or utils.root.options)
      if ((_G.type(_607_0) == "table") and (_607_0["compiler-env"] == "strict")) then
        provided = safe_compiler_env()
      elseif ((_G.type(_607_0) == "table") and (nil ~= _607_0.compilerEnv)) then
        local compilerEnv = _607_0.compilerEnv
        provided = compilerEnv
      elseif ((_G.type(_607_0) == "table") and (nil ~= _607_0["compiler-env"])) then
        local compiler_env = _607_0["compiler-env"]
    ...
    local function _610_(symbol)
      compiler.assert(compiler.scopes.macro, "must call from macro", ast)
      return compiler.scopes.macro.manglings[tostring(symbol)]
    end
    local function _611_(base)
      return utils.sym(compiler.gensym((compiler.scopes.macro or scope), base))
    end
    local function _612_(form)
      compiler.assert(compiler.scopes.macro, "must call from macro", ast)
      return compiler.macroexpand(form, compiler.scopes.macro)
    end
    env = {["assert-compile"] = compiler.assert, ["ast-source"] = utils["ast-source"], ["comment?"] = utils["comment?"], ["fennel-module-name"] = fennel_module_name, ["get-scope"] = _609_, ["in-scope?"] = _610_, ["list?"] = utils["list?"], ["macro-loaded"] = macro_loaded, ["multi-sym?"] = utils["multi-sym?"], ["sequence?"] = utils["sequence?"], ["sym?"] = utils["sym?"], ["table?"] = utils["table?"], ["varg?"] = utils["varg?"], _AST = ast, _CHUNK = parent, _IS_COMPILER = true, _SCOPE = scope, _SPECIALS = compiler.scopes.global.specials, _VARARG = utils.varg(), comment = utils.comment, gensym = _611_, list = utils.list, macroexpand = _612_, sequence = utils.sequence, sym = utils.sym, unpack = unpack, version = utils.version, view = view}
    env._G = env
  ...
  local _615_ = _613_(...)
  local dirsep = _615_[1]
  local pathsep = _615_[2]
  local pathmark = _615_[3]
  ...
  local function search_module(modulename, _3fpathstring)
    ...
    local function try_path(path)
      ...
      local _616_0 = (io.open(filename) or io.open(filename2))
      if (nil ~= _616_0) then
        local file = _616_0
        file:close()
        return filename
    ...
    local function find_in_path(start, _3ftried_paths)
      local _618_0 = fullpath:match(pattern, start)
      if (nil ~= _618_0) then
        local path = _618_0
        local _619_0, _620_0 = try_path(path)
        if (nil ~= _619_0) then
          local filename = _619_0
          return filename
        elseif ((_619_0 == nil) and (nil ~= _620_0)) then
          local error = _620_0
          local function _622_()
            local _621_0 = (_3ftried_paths or {})
            table.insert(_621_0, error)
            return _621_0
          end
          return find_in_path((start + #path + 1), _622_())
        end
      else
        local _ = _618_0
        local function _624_()
  ...
  local function make_searcher(_3foptions)
    local function _627_(module_name)
      local opts = utils.copy(utils.root.options)
      for k, v in pairs((_3foptions or {})) do
        opts[k] = v
      end
      opts["module-name"] = module_name
      local _628_0, _629_0 = search_module(module_name)
      if (nil ~= _628_0) then
        local filename = _628_0
        local function _630_(...)
          return utils["fennel-module"].dofile(filename, opts, ...)
        end
        return _630_, filename
      elseif ((_628_0 == nil) and (nil ~= _629_0)) then
        local error = _629_0
        return error
      end
    end
  ...
  local function fennel_macro_searcher(module_name)
    local opts = nil
    do
      local _632_0 = utils.copy(utils.root.options)
      _632_0["module-name"] = module_name
      _632_0["env"] = "_COMPILER"
      _632_0["requireAsInclude"] = false
      _632_0["allowedGlobals"] = nil
      opts = _632_0
    end
    local _633_0 = search_module(module_name, utils["fennel-module"]["macro-path"])
    if (nil ~= _633_0) then
      local filename = _633_0
      local _634_
      ...
      return _634_, filename
    end
  end
  local function lua_macro_searcher(module_name)
    local _639_0 = search_module(module_name, package.path)
    if (nil ~= _639_0) then
      local filename = _639_0
      local code = nil
      do
        ...
        code = close_handlers_10_(_G.xpcall(_641_, (package.loaded.fennel or debug).traceback))
      end
  ...
  local function search_macro_module(modname, n)
    local _643_0 = macro_searchers[n]
    if (nil ~= _643_0) then
      local f = _643_0
      local _644_0, _645_0 = f(modname)
      if ((nil ~= _644_0) and true) then
        local loader = _644_0
        local _3ffilename = _645_0
  ...
  local function sandbox_fennel_module(modname)
    if ((modname == "fennel.macros") or (package and package.loaded and ("table" == type(package.loaded[modname])) and (package.loaded[modname].metadata == compiler.metadata))) then
      local function _648_(_, ...)
        return (compiler.metadata):setall(...)
      end
      return {metadata = {setall = _648_}, view = view}
    end
  end
  local function _650_(modname)
    ...
    return (macro_loaded[modname] or sandbox_fennel_module(modname) or _651_())
  end
  safe_require = _650_
  ...
  local function resolve_module_name(_652_0, _scope, _parent, opts)
    local _653_ = _652_0
    local second = _653_[2]
    local filename = _653_["filename"]
  ...
  local function include_path(ast, opts, path, mod, fennel_3f)
    ...
    do
      ...
      src = close_handlers_10_(_G.xpcall(_659_, (package.loaded.fennel or debug).traceback))
    end
  ...
  SPECIALS.include = function(ast, scope, parent, opts)
    ...
    local modexpr = nil
    do
      local _662_0, _663_0 = pcall(resolve_module_name, ast, scope, parent, opts)
      if ((_662_0 == true) and (nil ~= _663_0)) then
        local modname = _663_0
    ...
    if ((modexpr.type ~= "literal") or ((modexpr[1]):byte() ~= 34)) then
      ...
      local function _667_()
        local _666_0 = search_module(mod)
        if (nil ~= _666_0) then
          local fennel_path = _666_0
      ...
      res = ((utils["member?"](mod, (utils.root.options.skipInclude or {})) and opts.fallback(modexpr, true)) or include_circular_fallback(mod, modexpr, opts.fallback, ast) or utils.root.scope.includes[mod] or _667_())
  ...
  SPECIALS["pick-values"] = function(ast, scope, parent)
    ...
    if (1 == n) then
      local _671_ = compiler.compile1(vals, scope, parent, {nval = 1})
      local _672_ = _671_[1]
      local expr = _672_[1]
      return {("(" .. expr .. ")")}
    elseif (0 == n) then
...
package.preload["fennel.compiler"] = package.preload["fennel.compiler"] or function(...)
  ...
  local function next_append(given_scope)
    local scope = root_scope(given_scope)
    scope["gensym-append"] = ((scope["gensym-append"] or 0) + 1)
    return ("_" .. scope["gensym-append"] .. "_")
  end
  local function gensym(scope, _3fbase, _3fsuffix)
    local mangling = ((_3fbase or "") .. next_append(scope) .. (_3fsuffix or ""))
    while scope.unmanglings[mangling] do
      mangling = ((_3fbase or "") .. next_append(scope) .. (_3fsuffix or ""))
    end
...
local function eval(str, _3foptions, ...)
  ...
  loader = specials["load-code"](lua_source, env, _816_(...))
  opts.filename = nil
  return loader(...)
end
...
local function syntax()
  ...
  for k, v in pairs(_G) do
    local _817_0 = type(v)
    if (_817_0 == "function") then
      out[k] = {["function?"] = true, ["global?"] = true}
    elseif (_817_0 == "table") then
...
do
  ...
  package.preload[module_name] = _821_
  _ = nil
  local env = nil
  do
    local _822_0 = specials["make-compiler-env"](nil, compiler.scopes.compiler, {})
    _822_0["utils"] = utils
    _822_0["fennel"] = mod
    _822_0["get-function-metadata"] = specials["get-function-metadata"]
    env = _822_0
  end
